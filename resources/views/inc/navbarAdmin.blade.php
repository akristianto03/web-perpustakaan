<nav class="navbar navbar-expand-lg navbar-light px-3">
    ...
    @if (Auth::check())
        <div>
            <a class="text-decoration-none nav-link dropdown-toggle text-gray-400" type="button"
                id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Hai,
                <span>{{ Auth::user()->name }}</span></a>
            <!-- Dropdown - User Information -->
            <div class="dropdown-menu dropdown-menu-end shadow animated--grow-in" aria-labelledby="dropdownMenuButton">
